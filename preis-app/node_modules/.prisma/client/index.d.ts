...
/**
   ...
   * `prisma.lottery`: Exposes CRUD operations for the **Lottery** model.
    ...
    * ```
    */
  get lottery(): Prisma.LotteryDelegate<GlobalReject>;

  /**
   * `prisma.fCFS`: Exposes CRUD operations for the **FCFS** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more FCFS
    * const fCFS = await prisma.fCFS.findMany()
    * ```
    */
  get fCFS(): Prisma.FCFSDelegate<GlobalReject>;
...
export namespace Prisma {
  ...
  */
  ...
  export type WalletGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> :  P extends keyof Wallet ? Wallet[P] : never
  } 
    : Wallet
  : Wallet
  ...
  export type ItemSelect = {
    ...
    isPublished?: boolean
    user?: boolean | UserArgs
    lottery?: boolean | LotteryFindManyArgs
    FCFS?: boolean | FCFSFindManyArgs
  ...
  export type ItemGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'lottery' ? Array < LotteryGetPayload<S['include'][P]>>  :
        P extends 'FCFS' ? Array < FCFSGetPayload<S['include'][P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'lottery' ? Array < LotteryGetPayload<S['select'][P]>>  :
        P extends 'FCFS' ? Array < FCFSGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__ItemClient<T> implements PrismaPromise<T> {
    ...
    lottery<T extends LotteryFindManyArgs = {}>(args?: Subset<T, LotteryFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Lottery>>, PrismaPromise<Array<LotteryGetPayload<T>>>>;

    FCFS<T extends FCFSFindManyArgs = {}>(args?: Subset<T, FCFSFindManyArgs>): CheckSelect<T, PrismaPromise<Array<FCFS>>, PrismaPromise<Array<FCFSGetPayload<T>>>>;
  ...
  export type LotteryAggregateArgs = {
    /**
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<LotteryOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
  ...
  export type LotteryGroupByArgs = {
    where?: LotteryWhereInput
    orderBy?: Enumerable<LotteryOrderByWithAggregationInput>
    by: Array<LotteryScalarFieldEnum>
  ...
  type GetLotteryGroupByPayload<T extends LotteryGroupByArgs> = PrismaPromise<
    Array<
      PickArray<LotteryGroupByOutputType, T['by']> &
        {
  ...
  export type LotteryInclude = {
    item?: boolean | ItemArgs
  }

  export type LotteryGetPayload<
    S extends boolean | null | undefined | LotteryArgs,
    U = keyof S
      > = S extends true
        ? Lottery
    : S extends undefined
    ? never
    : S extends LotteryArgs | LotteryFindManyArgs
    ?'include' extends U
    ? Lottery  & {
    [P in TrueKeys<S['include']>]:
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'item' ? ItemGetPayload<S['select'][P]> :  P extends keyof Lottery ? Lottery[P] : never
  } 
    : Lottery
  : Lottery


  type LotteryCountArgs = Merge<
    Omit<LotteryFindManyArgs, 'select' | 'include'> & {
      select?: LotteryCountAggregateInputType | true
    }
  >

  export interface LotteryDelegate<GlobalRejectSettings> {
    /**
     ...
     * })
    **/
    findUnique<T extends LotteryFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, LotteryFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Lottery'> extends True ? CheckSelect<T, Prisma__LotteryClient<Lottery>, Prisma__LotteryClient<LotteryGetPayload<T>>> : CheckSelect<T, Prisma__LotteryClient<Lottery | null >, Prisma__LotteryClient<LotteryGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends LotteryFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, LotteryFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Lottery'> extends True ? CheckSelect<T, Prisma__LotteryClient<Lottery>, Prisma__LotteryClient<LotteryGetPayload<T>>> : CheckSelect<T, Prisma__LotteryClient<Lottery | null >, Prisma__LotteryClient<LotteryGetPayload<T> | null >>
     ...
     * 
    **/
    findMany<T extends LotteryFindManyArgs>(
      args?: SelectSubset<T, LotteryFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<Lottery>>, PrismaPromise<Array<LotteryGetPayload<T>>>>
     ...
     * 
    **/
    create<T extends LotteryCreateArgs>(
      args: SelectSubset<T, LotteryCreateArgs>
    ): CheckSelect<T, Prisma__LotteryClient<Lottery>, Prisma__LotteryClient<LotteryGetPayload<T>>>
     ...
     *     
    **/
    createMany<T extends LotteryCreateManyArgs>(
      args?: SelectSubset<T, LotteryCreateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * 
    **/
    delete<T extends LotteryDeleteArgs>(
      args: SelectSubset<T, LotteryDeleteArgs>
    ): CheckSelect<T, Prisma__LotteryClient<Lottery>, Prisma__LotteryClient<LotteryGetPayload<T>>>
     ...
     * 
    **/
    update<T extends LotteryUpdateArgs>(
      args: SelectSubset<T, LotteryUpdateArgs>
    ): CheckSelect<T, Prisma__LotteryClient<Lottery>, Prisma__LotteryClient<LotteryGetPayload<T>>>
     ...
     * 
    **/
    deleteMany<T extends LotteryDeleteManyArgs>(
      args?: SelectSubset<T, LotteryDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends LotteryUpdateManyArgs>(
      args: SelectSubset<T, LotteryUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends LotteryUpsertArgs>(
      args: SelectSubset<T, LotteryUpsertArgs>
    ): CheckSelect<T, Prisma__LotteryClient<Lottery>, Prisma__LotteryClient<LotteryGetPayload<T>>>

    /**
     * Find one Lottery that matches the filter or throw
     * `NotFoundError` if no matches were found.
     ...
     * })
    **/
    findUniqueOrThrow<T extends LotteryFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, LotteryFindUniqueOrThrowArgs>
    ): CheckSelect<T, Prisma__LotteryClient<Lottery>, Prisma__LotteryClient<LotteryGetPayload<T>>>
     ...
     * })
    **/
    findFirstOrThrow<T extends LotteryFindFirstOrThrowArgs>(
      args?: SelectSubset<T, LotteryFindFirstOrThrowArgs>
    ): CheckSelect<T, Prisma__LotteryClient<Lottery>, Prisma__LotteryClient<LotteryGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends LotteryAggregateArgs>(args: Subset<T, LotteryAggregateArgs>): PrismaPromise<GetLotteryAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, LotteryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetLotteryGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__LotteryClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  /**
   * Lottery base type for findUnique actions
   */
  export type LotteryFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the Lottery
     * 
    **/
    select?: LotterySelect | null
    /**
     * Choose, which related nodes to fetch as well.
     * 
    **/
    include?: LotteryInclude | null
    /**
   ...
   * Lottery: findUnique
   */
  export interface LotteryFindUniqueArgs extends LotteryFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * Lottery base type for findFirst actions
   */
  export type LotteryFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Lottery
     * 
    **/
    ...
    **/
     ...
     * 
    **/
    distinct?: Enumerable<LotteryScalarFieldEnum>
  }

  /**
   * Lottery: findFirst
   */
  export interface LotteryFindFirstArgs extends LotteryFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   * Lottery createMany
   */
  export type LotteryCreateManyArgs = {
    /**
     * The data used to create many Lotteries.
     * 
    **/
    data: Enumerable<LotteryCreateManyInput>
    skipDuplicates?: boolean
  }
   ...
   * Lottery updateMany
   */
  export type LotteryUpdateManyArgs = {
    /**
   ...
   * Lottery deleteMany
   */
  export type LotteryDeleteManyArgs = {
    /**
   ...
   */
  export type LotteryFindUniqueOrThrowArgs = LotteryFindUniqueArgsBase
      

  /**
   * Lottery: findFirstOrThrow
   */
  export type LotteryFindFirstOrThrowArgs = LotteryFindFirstArgsBase
  ...
  export type AggregateFCFS = {
    _count: FCFSCountAggregateOutputType | null
    _avg: FCFSAvgAggregateOutputType | null
    _sum: FCFSSumAggregateOutputType | null
    _min: FCFSMinAggregateOutputType | null
    _max: FCFSMaxAggregateOutputType | null
  }

  export type FCFSAvgAggregateOutputType = {
    id: number | null
    itemId: number | null
    quantity: number | null
  }

  export type FCFSSumAggregateOutputType = {
    id: number | null
    itemId: number | null
    quantity: number | null
  }

  export type FCFSMinAggregateOutputType = {
    id: number | null
    itemId: number | null
    quantity: number | null
    deadline: Date | null
  ...
  export type FCFSMaxAggregateOutputType = {
    id: number | null
    itemId: number | null
    quantity: number | null
    deadline: Date | null
  ...
  export type FCFSCountAggregateOutputType = {
    id: number
    itemId: number
    minters: number
    quantity: number
  ...
  export type FCFSAvgAggregateInputType = {
    id?: true
    itemId?: true
    quantity?: true
  }

  export type FCFSSumAggregateInputType = {
    id?: true
    itemId?: true
    quantity?: true
  }

  export type FCFSMinAggregateInputType = {
    id?: true
    itemId?: true
    quantity?: true
    deadline?: true
  ...
  export type FCFSMaxAggregateInputType = {
    id?: true
    itemId?: true
    quantity?: true
    deadline?: true
  ...
  export type FCFSCountAggregateInputType = {
    id?: true
    itemId?: true
    minters?: true
    quantity?: true
  ...
  export type FCFSAggregateArgs = {
    /**
     * Filter which FCFS to aggregate.
     * 
    **/
    where?: FCFSWhereInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
     * 
     * Determine the order of FCFS to fetch.
     * 
    **/
    orderBy?: Enumerable<FCFSOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
     * 
    **/
    cursor?: FCFSWhereUniqueInput
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
     * 
     * Take `±n` FCFS from the position of the cursor.
     * 
    **/
    take?: number
    /**
    ...
    **/
     ...
     * Count returned FCFS
    **/
    _count?: true | FCFSCountAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to average
    **/
    _avg?: FCFSAvgAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to sum
    **/
    _sum?: FCFSSumAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
    **/
    _min?: FCFSMinAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the maximum value
    **/
    _max?: FCFSMaxAggregateInputType
  }

  export type GetFCFSAggregateType<T extends FCFSAggregateArgs> = {
        [P in keyof T & keyof AggregateFCFS]: P extends '_count' | 'count'
      ? T[P] extends true
        ? number
        : GetScalarType<T[P], AggregateFCFS[P]>
      : GetScalarType<T[P], AggregateFCFS[P]>
  }
  ...
  export type FCFSGroupByArgs = {
    where?: FCFSWhereInput
    orderBy?: Enumerable<FCFSOrderByWithAggregationInput>
    by: Array<FCFSScalarFieldEnum>
    having?: FCFSScalarWhereWithAggregatesInput
    take?: number
    skip?: number
    _count?: FCFSCountAggregateInputType | true
    _avg?: FCFSAvgAggregateInputType
    _sum?: FCFSSumAggregateInputType
    _min?: FCFSMinAggregateInputType
    _max?: FCFSMaxAggregateInputType
  ...
  export type FCFSGroupByOutputType = {
    id: number
    itemId: number
    minters: string[]
    quantity: number
  ...
  type GetFCFSGroupByPayload<T extends FCFSGroupByArgs> = PrismaPromise<
    Array<
      PickArray<FCFSGroupByOutputType, T['by']> &
        {
          [P in ((keyof T) & (keyof FCFSGroupByOutputType))]: P extends '_count'
            ? T[P] extends boolean
              ? number
              : GetScalarType<T[P], FCFSGroupByOutputType[P]>
            : GetScalarType<T[P], FCFSGroupByOutputType[P]>
        }
      >
    >
  ...
  export type FCFSInclude = {
    item?: boolean | ItemArgs
  }

  export type FCFSGetPayload<
    S extends boolean | null | undefined | FCFSArgs,
    U = keyof S
      > = S extends true
        ? FCFS
    : S extends undefined
    ? never
    : S extends FCFSArgs | FCFSFindManyArgs
    ?'include' extends U
    ? FCFS  & {
    [P in TrueKeys<S['include']>]:
        P extends 'item' ? ItemGetPayload<S['include'][P]> :  never
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'item' ? ItemGetPayload<S['select'][P]> :  P extends keyof FCFS ? FCFS[P] : never
  } 
    : FCFS
  : FCFS


  type FCFSCountArgs = Merge<
    Omit<FCFSFindManyArgs, 'select' | 'include'> & {
      select?: FCFSCountAggregateInputType | true
    }
  >

  export interface FCFSDelegate<GlobalRejectSettings> {
    /**
     * Find zero or one FCFS that matches the filter.
     * @param {FCFSFindUniqueArgs} args - Arguments to find a FCFS
     * @example
     * // Get one FCFS
     * const fCFS = await prisma.fCFS.findUnique({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUnique<T extends FCFSFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, FCFSFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'FCFS'> extends True ? CheckSelect<T, Prisma__FCFSClient<FCFS>, Prisma__FCFSClient<FCFSGetPayload<T>>> : CheckSelect<T, Prisma__FCFSClient<FCFS | null >, Prisma__FCFSClient<FCFSGetPayload<T> | null >>

    /**
     * Find the first FCFS that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FCFSFindFirstArgs} args - Arguments to find a FCFS
     * @example
     * // Get one FCFS
     * const fCFS = await prisma.fCFS.findFirst({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirst<T extends FCFSFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, FCFSFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'FCFS'> extends True ? CheckSelect<T, Prisma__FCFSClient<FCFS>, Prisma__FCFSClient<FCFSGetPayload<T>>> : CheckSelect<T, Prisma__FCFSClient<FCFS | null >, Prisma__FCFSClient<FCFSGetPayload<T> | null >>

    /**
     * Find zero or more FCFS that matches the filter.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FCFSFindManyArgs=} args - Arguments to filter and select certain fields only.
     * @example
     * // Get all FCFS
     * const fCFS = await prisma.fCFS.findMany()
     * 
     * // Get first 10 FCFS
     * const fCFS = await prisma.fCFS.findMany({ take: 10 })
     * 
     * // Only select the `id`
     * const fCFSWithIdOnly = await prisma.fCFS.findMany({ select: { id: true } })
     * 
    **/
    findMany<T extends FCFSFindManyArgs>(
      args?: SelectSubset<T, FCFSFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<FCFS>>, PrismaPromise<Array<FCFSGetPayload<T>>>>

    /**
     * Create a FCFS.
     * @param {FCFSCreateArgs} args - Arguments to create a FCFS.
     * @example
     * // Create one FCFS
     * const FCFS = await prisma.fCFS.create({
     *   data: {
     *     // ... data to create a FCFS
     *   }
     * })
     * 
    **/
    create<T extends FCFSCreateArgs>(
      args: SelectSubset<T, FCFSCreateArgs>
    ): CheckSelect<T, Prisma__FCFSClient<FCFS>, Prisma__FCFSClient<FCFSGetPayload<T>>>

    /**
     * Create many FCFS.
     *     @param {FCFSCreateManyArgs} args - Arguments to create many FCFS.
     *     @example
     *     // Create many FCFS
     *     const fCFS = await prisma.fCFS.createMany({
     *       data: {
     *         // ... provide data here
     *       }
     *     })
     *     
    **/
    createMany<T extends FCFSCreateManyArgs>(
      args?: SelectSubset<T, FCFSCreateManyArgs>
    ): PrismaPromise<BatchPayload>

    /**
     * Delete a FCFS.
     * @param {FCFSDeleteArgs} args - Arguments to delete one FCFS.
     * @example
     * // Delete one FCFS
     * const FCFS = await prisma.fCFS.delete({
     *   where: {
     *     // ... filter to delete one FCFS
     *   }
     * })
     * 
    **/
    delete<T extends FCFSDeleteArgs>(
      args: SelectSubset<T, FCFSDeleteArgs>
    ): CheckSelect<T, Prisma__FCFSClient<FCFS>, Prisma__FCFSClient<FCFSGetPayload<T>>>

    /**
     * Update one FCFS.
     * @param {FCFSUpdateArgs} args - Arguments to update one FCFS.
     * @example
     * // Update one FCFS
     * const fCFS = await prisma.fCFS.update({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    update<T extends FCFSUpdateArgs>(
      args: SelectSubset<T, FCFSUpdateArgs>
    ): CheckSelect<T, Prisma__FCFSClient<FCFS>, Prisma__FCFSClient<FCFSGetPayload<T>>>

    /**
     * Delete zero or more FCFS.
     * @param {FCFSDeleteManyArgs} args - Arguments to filter FCFS to delete.
     * @example
     * // Delete a few FCFS
     * const { count } = await prisma.fCFS.deleteMany({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     * 
    **/
    deleteMany<T extends FCFSDeleteManyArgs>(
      args?: SelectSubset<T, FCFSDeleteManyArgs>
    ): PrismaPromise<BatchPayload>

    /**
     * Update zero or more FCFS.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FCFSUpdateManyArgs} args - Arguments to update one or more rows.
     * @example
     * // Update many FCFS
     * const fCFS = await prisma.fCFS.updateMany({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * 
    **/
    updateMany<T extends FCFSUpdateManyArgs>(
      args: SelectSubset<T, FCFSUpdateManyArgs>
    ): PrismaPromise<BatchPayload>

    /**
     * Create or update one FCFS.
     * @param {FCFSUpsertArgs} args - Arguments to update or create a FCFS.
     * @example
     * // Update or create a FCFS
     * const fCFS = await prisma.fCFS.upsert({
     *   create: {
     *     // ... data to create a FCFS
     *   },
     *   update: {
     ...
     *   },
     *   where: {
     *     // ... the filter for the FCFS we want to update
     *   }
     * })
    **/
    upsert<T extends FCFSUpsertArgs>(
      args: SelectSubset<T, FCFSUpsertArgs>
    ): CheckSelect<T, Prisma__FCFSClient<FCFS>, Prisma__FCFSClient<FCFSGetPayload<T>>>

    /**
     * Find one FCFS that matches the filter or throw
     * `NotFoundError` if no matches were found.
     * @param {FCFSFindUniqueOrThrowArgs} args - Arguments to find a FCFS
     * @example
     * // Get one FCFS
     * const fCFS = await prisma.fCFS.findUniqueOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findUniqueOrThrow<T extends FCFSFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, FCFSFindUniqueOrThrowArgs>
    ): CheckSelect<T, Prisma__FCFSClient<FCFS>, Prisma__FCFSClient<FCFSGetPayload<T>>>

    /**
     * Find the first FCFS that matches the filter or
     * throw `NotFoundError` if no matches were found.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FCFSFindFirstOrThrowArgs} args - Arguments to find a FCFS
     * @example
     * // Get one FCFS
     * const fCFS = await prisma.fCFS.findFirstOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
    **/
    findFirstOrThrow<T extends FCFSFindFirstOrThrowArgs>(
      args?: SelectSubset<T, FCFSFindFirstOrThrowArgs>
    ): CheckSelect<T, Prisma__FCFSClient<FCFS>, Prisma__FCFSClient<FCFSGetPayload<T>>>

    /**
     * Count the number of FCFS.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FCFSCountArgs} args - Arguments to filter FCFS to count.
     * @example
     * // Count the number of FCFS
     * const count = await prisma.fCFS.count({
     *   where: {
     *     // ... the filter for the FCFS we want to count
     *   }
     * })
    **/
    count<T extends FCFSCountArgs>(
      args?: Subset<T, FCFSCountArgs>,
    ): PrismaPromise<
      T extends _Record<'select', any>
        ? T['select'] extends true
          ? number
          : GetScalarType<T['select'], FCFSCountAggregateOutputType>
        : number
    >

    /**
     * Allows you to perform aggregations operations on a FCFS.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FCFSAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
     * @example
     * // Ordered by age ascending
     * // Where email contains prisma.io
     * // Limited to the 10 users
     ...
     * })
    **/
    aggregate<T extends FCFSAggregateArgs>(args: Subset<T, FCFSAggregateArgs>): PrismaPromise<GetFCFSAggregateType<T>>

    /**
     * Group by FCFS.
     * Note, that providing `undefined` is treated as the value not being there.
     * Read more here: https://pris.ly/d/null-undefined
     * @param {FCFSGroupByArgs} args - Group by arguments.
     * @example
     * // Group by city, order by createdAt, get count
     * const result = await prisma.user.groupBy({
     *   by: ['city', 'createdAt'],
    ...
    **/
    groupBy<
      T extends FCFSGroupByArgs,
      HasSelectOrTake extends Or<
        Extends<'skip', Keys<T>>,
        Extends<'take', Keys<T>>
      >,
      OrderByArg extends True extends HasSelectOrTake
        ? { orderBy: FCFSGroupByArgs['orderBy'] }
        : { orderBy?: FCFSGroupByArgs['orderBy'] },
      OrderFields extends ExcludeUnderscoreKeys<Keys<MaybeTupleToUnion<T['orderBy']>>>,
      ByFields extends TupleToUnion<T['by']>,
      ByValid extends Has<ByFields, OrderFields>,
    ...
    >(args: SubsetIntersection<T, FCFSGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFCFSGroupByPayload<T> : PrismaPromise<InputErrors>
  }

  /**
   * The delegate class that acts as a "Promise-like" for FCFS.
   * Why is this prefixed with `Prisma__`?
   * Because we want to prevent naming conflicts as mentioned in
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__FCFSClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  /**
   * FCFS base type for findUnique actions
   */
  export type FCFSFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the FCFS
     * 
    **/
    select?: FCFSSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     * 
    **/
    include?: FCFSInclude | null
    /**
     * Filter, which FCFS to fetch.
     * 
    **/
    where: FCFSWhereUniqueInput
  }

  /**
   * FCFS: findUnique
   */
  export interface FCFSFindUniqueArgs extends FCFSFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * FCFS base type for findFirst actions
   */
  export type FCFSFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the FCFS
     * 
    **/
    ...
    **/
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for searching for FCFS.
     * 
    **/
    cursor?: FCFSWhereUniqueInput
    /**
    ...
    **/
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/distinct Distinct Docs}
     * 
     * Filter by unique combinations of FCFS.
     * 
    **/
    distinct?: Enumerable<FCFSScalarFieldEnum>
  }

  /**
   * FCFS: findFirst
   */
  export interface FCFSFindFirstArgs extends FCFSFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
  ...
  export type FCFSFindManyArgs = {
    ...
    **/
     ...
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the position for listing FCFS.
     * 
    **/
    cursor?: FCFSWhereUniqueInput
    /**
  ...
  export type FCFSCreateArgs = {
    ...
    **/
    include?: FCFSInclude | null
    /**
     * The data needed to create a FCFS.
     * 
    **/
    data: XOR<FCFSCreateInput, FCFSUncheckedCreateInput>
  }
   ...
   * FCFS createMany
   */
  export type FCFSCreateManyArgs = {
    /**
     * The data used to create many FCFS.
     * 
    **/
    data: Enumerable<FCFSCreateManyInput>
    skipDuplicates?: boolean
  }
  ...
  export type FCFSUpdateArgs = {
    ...
    **/
    include?: FCFSInclude | null
    /**
     * The data needed to update a FCFS.
     * 
    **/
    data: XOR<FCFSUpdateInput, FCFSUncheckedUpdateInput>
    /**
     * Choose, which FCFS to update.
     * 
    **/
    where: FCFSWhereUniqueInput
  }
   ...
   * FCFS updateMany
   */
  export type FCFSUpdateManyArgs = {
    /**
     * The data used to update FCFS.
     * 
    **/
    data: XOR<FCFSUpdateManyMutationInput, FCFSUncheckedUpdateManyInput>
    /**
     * Filter which FCFS to update
     * 
    **/
    where?: FCFSWhereInput
  }
  ...
  export type FCFSUpsertArgs = {
    ...
    **/
    include?: FCFSInclude | null
    /**
     * The filter to search for the FCFS to update in case it exists.
     * 
    **/
    where: FCFSWhereUniqueInput
    /**
     * In case the FCFS found by the `where` argument doesn't exist, create a new FCFS with this data.
     * 
    **/
    create: XOR<FCFSCreateInput, FCFSUncheckedCreateInput>
    /**
     * In case the FCFS was found with the provided `where` argument, update it with this data.
     * 
    **/
    update: XOR<FCFSUpdateInput, FCFSUncheckedUpdateInput>
  }
   ...
   * FCFS deleteMany
   */
  export type FCFSDeleteManyArgs = {
    /**
     * Filter which FCFS to delete
     * 
    **/
  ...
  /**
   * FCFS: findUniqueOrThrow
   */
  export type FCFSFindUniqueOrThrowArgs = FCFSFindUniqueArgsBase
      

  /**
   * FCFS: findFirstOrThrow
   */
  export type FCFSFindFirstOrThrowArgs = FCFSFindFirstArgsBase
      

  /**
   * FCFS without action
   */
  export type FCFSArgs = {
    /**
     * Select specific fields to fetch from the FCFS
     * 
    **/
  ...
  export const FCFSScalarFieldEnum: {
    id: 'id',
    itemId: 'itemId',
    minters: 'minters',
    quantity: 'quantity',
  ...
  export type FCFSScalarFieldEnum = (typeof FCFSScalarFieldEnum)[keyof typeof FCFSScalarFieldEnum]
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    isCompany?: BoolWithAggregatesFilter | boolean
  }
  ...
  export type WalletScalarWhereWithAggregatesInput = {
    ...
    mnemonic?: StringWithAggregatesFilter | string
    userId?: IntWithAggregatesFilter | number
  }
  ...
  export type ItemWhereInput = {
    ...
    user?: XOR<UserRelationFilter, UserWhereInput>
    lottery?: LotteryListRelationFilter
    FCFS?: FCFSListRelationFilter
  }
  ...
  export type ItemOrderByWithRelationInput = {
    ...
    user?: UserOrderByWithRelationInput
    lottery?: LotteryOrderByRelationAggregateInput
    FCFS?: FCFSOrderByRelationAggregateInput
  }
  ...
  export type LotteryWhereInput = {
    AND?: Enumerable<LotteryWhereInput>
    OR?: Enumerable<LotteryWhereInput>
    NOT?: Enumerable<LotteryWhereInput>
    id?: IntFilter | number
    itemId?: IntFilter | number
    participants?: StringNullableListFilter
    minters?: StringNullableListFilter
  ...
  export type LotteryScalarWhereWithAggregatesInput = {
    AND?: Enumerable<LotteryScalarWhereWithAggregatesInput>
    OR?: Enumerable<LotteryScalarWhereWithAggregatesInput>
    NOT?: Enumerable<LotteryScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
  ...
  export type FCFSWhereInput = {
    AND?: Enumerable<FCFSWhereInput>
    OR?: Enumerable<FCFSWhereInput>
    NOT?: Enumerable<FCFSWhereInput>
    id?: IntFilter | number
    itemId?: IntFilter | number
    minters?: StringNullableListFilter
    quantity?: IntFilter | number
  ...
  export type FCFSOrderByWithRelationInput = {
    id?: SortOrder
    itemId?: SortOrder
    minters?: SortOrder
    quantity?: SortOrder
  ...
  export type FCFSWhereUniqueInput = {
    id?: number
  }

  export type FCFSOrderByWithAggregationInput = {
    id?: SortOrder
    itemId?: SortOrder
    minters?: SortOrder
    quantity?: SortOrder
    deadline?: SortOrder
    _count?: FCFSCountOrderByAggregateInput
    _avg?: FCFSAvgOrderByAggregateInput
    _max?: FCFSMaxOrderByAggregateInput
    _min?: FCFSMinOrderByAggregateInput
    _sum?: FCFSSumOrderByAggregateInput
  }

  export type FCFSScalarWhereWithAggregatesInput = {
    AND?: Enumerable<FCFSScalarWhereWithAggregatesInput>
    OR?: Enumerable<FCFSScalarWhereWithAggregatesInput>
    NOT?: Enumerable<FCFSScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
    itemId?: IntWithAggregatesFilter | number
    minters?: StringNullableListFilter
    quantity?: IntWithAggregatesFilter | number
  ...
  export type ItemCreateInput = {
    ...
    lottery?: LotteryCreateNestedManyWithoutItemInput
    FCFS?: FCFSCreateNestedManyWithoutItemInput
  }
  ...
  export type ItemUncheckedCreateInput = {
    ...
    quantity?: number | null
    isPublished?: boolean
    lottery?: LotteryUncheckedCreateNestedManyWithoutItemInput
    FCFS?: FCFSUncheckedCreateNestedManyWithoutItemInput
  }
  ...
  export type ItemUpdateInput = {
    ...
    lottery?: LotteryUpdateManyWithoutItemNestedInput
    FCFS?: FCFSUpdateManyWithoutItemNestedInput
  }
  ...
  export type ItemUncheckedUpdateInput = {
    ...
    quantity?: NullableIntFieldUpdateOperationsInput | number | null
    isPublished?: BoolFieldUpdateOperationsInput | boolean
    lottery?: LotteryUncheckedUpdateManyWithoutItemNestedInput
    FCFS?: FCFSUncheckedUpdateManyWithoutItemNestedInput
  }
  ...
  export type LotteryCreateInput = {
    participants?: LotteryCreateparticipantsInput | Enumerable<string>
    minters?: LotteryCreatemintersInput | Enumerable<string>
    quantity: number
    deadline: Date | string
    item: ItemCreateNestedOneWithoutLotteryInput
  }
  ...
  export type LotteryUpdateInput = {
    participants?: LotteryUpdateparticipantsInput | Enumerable<string>
    minters?: LotteryUpdatemintersInput | Enumerable<string>
    quantity?: IntFieldUpdateOperationsInput | number
    deadline?: DateTimeFieldUpdateOperationsInput | Date | string
    item?: ItemUpdateOneRequiredWithoutLotteryNestedInput
  }
  ...
  export type FCFSCreateInput = {
    minters?: FCFSCreatemintersInput | Enumerable<string>
    quantity: number
    deadline: Date | string
    item: ItemCreateNestedOneWithoutFCFSInput
  }

  export type FCFSUncheckedCreateInput = {
    id?: number
    itemId: number
    minters?: FCFSCreatemintersInput | Enumerable<string>
    quantity: number
  ...
  export type FCFSUpdateInput = {
    minters?: FCFSUpdatemintersInput | Enumerable<string>
    quantity?: IntFieldUpdateOperationsInput | number
    deadline?: DateTimeFieldUpdateOperationsInput | Date | string
    item?: ItemUpdateOneRequiredWithoutFCFSNestedInput
  }

  export type FCFSUncheckedUpdateInput = {
    id?: IntFieldUpdateOperationsInput | number
    itemId?: IntFieldUpdateOperationsInput | number
    minters?: FCFSUpdatemintersInput | Enumerable<string>
    quantity?: IntFieldUpdateOperationsInput | number
  ...
  export type FCFSCreateManyInput = {
    id?: number
    itemId: number
    minters?: FCFSCreatemintersInput | Enumerable<string>
    quantity: number
  ...
  export type FCFSUpdateManyMutationInput = {
    minters?: FCFSUpdatemintersInput | Enumerable<string>
    quantity?: IntFieldUpdateOperationsInput | number
    deadline?: DateTimeFieldUpdateOperationsInput | Date | string
  }

  export type FCFSUncheckedUpdateManyInput = {
    id?: IntFieldUpdateOperationsInput | number
    itemId?: IntFieldUpdateOperationsInput | number
    minters?: FCFSUpdatemintersInput | Enumerable<string>
    quantity?: IntFieldUpdateOperationsInput | number
  ...
  export type FCFSListRelationFilter = {
    every?: FCFSWhereInput
    some?: FCFSWhereInput
    none?: FCFSWhereInput
  }
  ...
  export type FCFSOrderByRelationAggregateInput = {
    _count?: SortOrder
  }
  ...
  export type FCFSCountOrderByAggregateInput = {
    id?: SortOrder
    itemId?: SortOrder
    minters?: SortOrder
    quantity?: SortOrder
  ...
  export type FCFSAvgOrderByAggregateInput = {
    id?: SortOrder
    itemId?: SortOrder
    quantity?: SortOrder
  }

  export type FCFSMaxOrderByAggregateInput = {
    id?: SortOrder
    itemId?: SortOrder
    quantity?: SortOrder
    deadline?: SortOrder
  ...
  export type FCFSMinOrderByAggregateInput = {
    id?: SortOrder
    itemId?: SortOrder
    quantity?: SortOrder
    deadline?: SortOrder
  ...
  export type FCFSSumOrderByAggregateInput = {
    id?: SortOrder
    itemId?: SortOrder
    quantity?: SortOrder
  }
  ...
  export type LotteryCreateNestedManyWithoutItemInput = {
    create?: XOR<Enumerable<LotteryCreateWithoutItemInput>, Enumerable<LotteryUncheckedCreateWithoutItemInput>>
    connectOrCreate?: Enumerable<LotteryCreateOrConnectWithoutItemInput>
    createMany?: LotteryCreateManyItemInputEnvelope
    connect?: Enumerable<LotteryWhereUniqueInput>
  }

  export type FCFSCreateNestedManyWithoutItemInput = {
    create?: XOR<Enumerable<FCFSCreateWithoutItemInput>, Enumerable<FCFSUncheckedCreateWithoutItemInput>>
    connectOrCreate?: Enumerable<FCFSCreateOrConnectWithoutItemInput>
    createMany?: FCFSCreateManyItemInputEnvelope
    connect?: Enumerable<FCFSWhereUniqueInput>
  }

  export type LotteryUncheckedCreateNestedManyWithoutItemInput = {
    create?: XOR<Enumerable<LotteryCreateWithoutItemInput>, Enumerable<LotteryUncheckedCreateWithoutItemInput>>
    connectOrCreate?: Enumerable<LotteryCreateOrConnectWithoutItemInput>
    createMany?: LotteryCreateManyItemInputEnvelope
    connect?: Enumerable<LotteryWhereUniqueInput>
  ...
  export type FCFSUncheckedCreateNestedManyWithoutItemInput = {
    create?: XOR<Enumerable<FCFSCreateWithoutItemInput>, Enumerable<FCFSUncheckedCreateWithoutItemInput>>
    connectOrCreate?: Enumerable<FCFSCreateOrConnectWithoutItemInput>
    createMany?: FCFSCreateManyItemInputEnvelope
    connect?: Enumerable<FCFSWhereUniqueInput>
  ...
  export type LotteryUpdateManyWithoutItemNestedInput = {
    create?: XOR<Enumerable<LotteryCreateWithoutItemInput>, Enumerable<LotteryUncheckedCreateWithoutItemInput>>
    connectOrCreate?: Enumerable<LotteryCreateOrConnectWithoutItemInput>
    upsert?: Enumerable<LotteryUpsertWithWhereUniqueWithoutItemInput>
    createMany?: LotteryCreateManyItemInputEnvelope
    set?: Enumerable<LotteryWhereUniqueInput>
    disconnect?: Enumerable<LotteryWhereUniqueInput>
    delete?: Enumerable<LotteryWhereUniqueInput>
    connect?: Enumerable<LotteryWhereUniqueInput>
    update?: Enumerable<LotteryUpdateWithWhereUniqueWithoutItemInput>
    updateMany?: Enumerable<LotteryUpdateManyWithWhereWithoutItemInput>
    deleteMany?: Enumerable<LotteryScalarWhereInput>
  }

  export type FCFSUpdateManyWithoutItemNestedInput = {
    create?: XOR<Enumerable<FCFSCreateWithoutItemInput>, Enumerable<FCFSUncheckedCreateWithoutItemInput>>
    connectOrCreate?: Enumerable<FCFSCreateOrConnectWithoutItemInput>
    upsert?: Enumerable<FCFSUpsertWithWhereUniqueWithoutItemInput>
    createMany?: FCFSCreateManyItemInputEnvelope
    set?: Enumerable<FCFSWhereUniqueInput>
    disconnect?: Enumerable<FCFSWhereUniqueInput>
    delete?: Enumerable<FCFSWhereUniqueInput>
    connect?: Enumerable<FCFSWhereUniqueInput>
    update?: Enumerable<FCFSUpdateWithWhereUniqueWithoutItemInput>
    updateMany?: Enumerable<FCFSUpdateManyWithWhereWithoutItemInput>
    deleteMany?: Enumerable<FCFSScalarWhereInput>
  }

  export type LotteryUncheckedUpdateManyWithoutItemNestedInput = {
    create?: XOR<Enumerable<LotteryCreateWithoutItemInput>, Enumerable<LotteryUncheckedCreateWithoutItemInput>>
    connectOrCreate?: Enumerable<LotteryCreateOrConnectWithoutItemInput>
    upsert?: Enumerable<LotteryUpsertWithWhereUniqueWithoutItemInput>
    createMany?: LotteryCreateManyItemInputEnvelope
  ...
  export type FCFSUncheckedUpdateManyWithoutItemNestedInput = {
    create?: XOR<Enumerable<FCFSCreateWithoutItemInput>, Enumerable<FCFSUncheckedCreateWithoutItemInput>>
    connectOrCreate?: Enumerable<FCFSCreateOrConnectWithoutItemInput>
    upsert?: Enumerable<FCFSUpsertWithWhereUniqueWithoutItemInput>
    createMany?: FCFSCreateManyItemInputEnvelope
  ...
  export type LotteryCreateparticipantsInput = {
    set: Enumerable<string>
  }

  export type LotteryCreatemintersInput = {
    set: Enumerable<string>
  }

  export type ItemCreateNestedOneWithoutLotteryInput = {
    create?: XOR<ItemCreateWithoutLotteryInput, ItemUncheckedCreateWithoutLotteryInput>
    connectOrCreate?: ItemCreateOrConnectWithoutLotteryInput
    connect?: ItemWhereUniqueInput
  }

  export type LotteryUpdateparticipantsInput = {
    set?: Enumerable<string>
    push?: string | Enumerable<string>
  }

  export type LotteryUpdatemintersInput = {
    set?: Enumerable<string>
    push?: string | Enumerable<string>
  }
  ...
  export type ItemUpdateOneRequiredWithoutLotteryNestedInput = {
    create?: XOR<ItemCreateWithoutLotteryInput, ItemUncheckedCreateWithoutLotteryInput>
    connectOrCreate?: ItemCreateOrConnectWithoutLotteryInput
    upsert?: ItemUpsertWithoutLotteryInput
    connect?: ItemWhereUniqueInput
    update?: XOR<ItemUpdateWithoutLotteryInput, ItemUncheckedUpdateWithoutLotteryInput>
  }

  export type FCFSCreatemintersInput = {
    set: Enumerable<string>
  }

  export type ItemCreateNestedOneWithoutFCFSInput = {
    create?: XOR<ItemCreateWithoutFCFSInput, ItemUncheckedCreateWithoutFCFSInput>
    connectOrCreate?: ItemCreateOrConnectWithoutFCFSInput
    connect?: ItemWhereUniqueInput
  }

  export type FCFSUpdatemintersInput = {
    set?: Enumerable<string>
    push?: string | Enumerable<string>
  }

  export type ItemUpdateOneRequiredWithoutFCFSNestedInput = {
    create?: XOR<ItemCreateWithoutFCFSInput, ItemUncheckedCreateWithoutFCFSInput>
    connectOrCreate?: ItemCreateOrConnectWithoutFCFSInput
    upsert?: ItemUpsertWithoutFCFSInput
    connect?: ItemWhereUniqueInput
    update?: XOR<ItemUpdateWithoutFCFSInput, ItemUncheckedUpdateWithoutFCFSInput>
  }
  ...
  export type LotteryCreateOrConnectWithoutItemInput = {
    where: LotteryWhereUniqueInput
    create: XOR<LotteryCreateWithoutItemInput, LotteryUncheckedCreateWithoutItemInput>
  }

  export type LotteryCreateManyItemInputEnvelope = {
    data: Enumerable<LotteryCreateManyItemInput>
    skipDuplicates?: boolean
  }

  export type FCFSCreateWithoutItemInput = {
    minters?: FCFSCreatemintersInput | Enumerable<string>
    quantity: number
    deadline: Date | string
  }

  export type FCFSUncheckedCreateWithoutItemInput = {
    id?: number
    minters?: FCFSCreatemintersInput | Enumerable<string>
    quantity: number
    deadline: Date | string
  ...
  export type FCFSCreateOrConnectWithoutItemInput = {
    where: FCFSWhereUniqueInput
    create: XOR<FCFSCreateWithoutItemInput, FCFSUncheckedCreateWithoutItemInput>
  }

  export type FCFSCreateManyItemInputEnvelope = {
    data: Enumerable<FCFSCreateManyItemInput>
    skipDuplicates?: boolean
  }
  ...
  export type LotteryUpsertWithWhereUniqueWithoutItemInput = {
    where: LotteryWhereUniqueInput
    update: XOR<LotteryUpdateWithoutItemInput, LotteryUncheckedUpdateWithoutItemInput>
    create: XOR<LotteryCreateWithoutItemInput, LotteryUncheckedCreateWithoutItemInput>
  }

  export type LotteryUpdateWithWhereUniqueWithoutItemInput = {
    where: LotteryWhereUniqueInput
    data: XOR<LotteryUpdateWithoutItemInput, LotteryUncheckedUpdateWithoutItemInput>
  }

  export type LotteryUpdateManyWithWhereWithoutItemInput = {
    where: LotteryScalarWhereInput
    data: XOR<LotteryUpdateManyMutationInput, LotteryUncheckedUpdateManyWithoutLotteryInput>
  }

  export type LotteryScalarWhereInput = {
    AND?: Enumerable<LotteryScalarWhereInput>
    OR?: Enumerable<LotteryScalarWhereInput>
    NOT?: Enumerable<LotteryScalarWhereInput>
    id?: IntFilter | number
    itemId?: IntFilter | number
    participants?: StringNullableListFilter
    minters?: StringNullableListFilter
  ...
  export type FCFSUpsertWithWhereUniqueWithoutItemInput = {
    where: FCFSWhereUniqueInput
    update: XOR<FCFSUpdateWithoutItemInput, FCFSUncheckedUpdateWithoutItemInput>
    create: XOR<FCFSCreateWithoutItemInput, FCFSUncheckedCreateWithoutItemInput>
  }

  export type FCFSUpdateWithWhereUniqueWithoutItemInput = {
    where: FCFSWhereUniqueInput
    data: XOR<FCFSUpdateWithoutItemInput, FCFSUncheckedUpdateWithoutItemInput>
  }

  export type FCFSUpdateManyWithWhereWithoutItemInput = {
    where: FCFSScalarWhereInput
    data: XOR<FCFSUpdateManyMutationInput, FCFSUncheckedUpdateManyWithoutFCFSInput>
  }

  export type FCFSScalarWhereInput = {
    AND?: Enumerable<FCFSScalarWhereInput>
    OR?: Enumerable<FCFSScalarWhereInput>
    NOT?: Enumerable<FCFSScalarWhereInput>
    id?: IntFilter | number
    itemId?: IntFilter | number
    minters?: StringNullableListFilter
    quantity?: IntFilter | number
  ...
  export type ItemCreateWithoutFCFSInput = {
    title?: string | null
    imagePath?: string | null
    price?: number | null
    quantity?: number | null
  ...
  export type ItemUncheckedCreateWithoutFCFSInput = {
    id?: number
    userId: number
    title?: string | null
    imagePath?: string | null
  ...
  export type ItemCreateOrConnectWithoutFCFSInput = {
    where: ItemWhereUniqueInput
    create: XOR<ItemCreateWithoutFCFSInput, ItemUncheckedCreateWithoutFCFSInput>
  }

  export type ItemUpsertWithoutFCFSInput = {
    update: XOR<ItemUpdateWithoutFCFSInput, ItemUncheckedUpdateWithoutFCFSInput>
    create: XOR<ItemCreateWithoutFCFSInput, ItemUncheckedCreateWithoutFCFSInput>
  }

  export type ItemUpdateWithoutFCFSInput = {
    title?: NullableStringFieldUpdateOperationsInput | string | null
    imagePath?: NullableStringFieldUpdateOperationsInput | string | null
    price?: NullableIntFieldUpdateOperationsInput | number | null
    quantity?: NullableIntFieldUpdateOperationsInput | number | null
  ...
  export type ItemUncheckedUpdateWithoutFCFSInput = {
    id?: IntFieldUpdateOperationsInput | number
    userId?: IntFieldUpdateOperationsInput | number
    title?: NullableStringFieldUpdateOperationsInput | string | null
    imagePath?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type LotteryCreateManyItemInput = {
    id?: number
    participants?: LotteryCreateparticipantsInput | Enumerable<string>
    minters?: LotteryCreatemintersInput | Enumerable<string>
    quantity: number
  ...
  export type FCFSCreateManyItemInput = {
    id?: number
    minters?: FCFSCreatemintersInput | Enumerable<string>
    quantity: number
    deadline: Date | string
  ...
  export type LotteryUncheckedUpdateManyWithoutLotteryInput = {
    id?: IntFieldUpdateOperationsInput | number
    participants?: LotteryUpdateparticipantsInput | Enumerable<string>
    minters?: LotteryUpdatemintersInput | Enumerable<string>
    quantity?: IntFieldUpdateOperationsInput | number
  ...
  export type FCFSUpdateWithoutItemInput = {
    minters?: FCFSUpdatemintersInput | Enumerable<string>
    quantity?: IntFieldUpdateOperationsInput | number
    deadline?: DateTimeFieldUpdateOperationsInput | Date | string
  }

  export type FCFSUncheckedUpdateWithoutItemInput = {
    id?: IntFieldUpdateOperationsInput | number
    minters?: FCFSUpdatemintersInput | Enumerable<string>
    quantity?: IntFieldUpdateOperationsInput | number
    deadline?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type FCFSUncheckedUpdateManyWithoutFCFSInput = {
    id?: IntFieldUpdateOperationsInput | number
    minters?: FCFSUpdatemintersInput | Enumerable<string>
    quantity?: IntFieldUpdateOperationsInput | number
    deadline?: DateTimeFieldUpdateOperationsInput | Date | string
